...
businessRouter.post(
  "/pos-config/reset",
  BusinessController.resetPosPasswords as any,
);
businessRouter.put(
  "/pos-config/main-password",
  BusinessController.changePosMainPassword as any,
);
businessRouter.put(
  "/pos-config/admin-password",
  BusinessController.changePosAdminPassword as any,
);
...
businessRouter.get(
  ...
  StockController.getByProduct as any,
);
...
businessRouter.get(
  ...
  ReportController.getStaffPerformance as any,
);
businessRouter.get(
  "/reports/financial-balance",
  ReportController.getFinancialBalance as any,
);
businessRouter.get(
  "/reports/stock-status",
  ReportController.getStockStatus as any,
);

// Reports — Excel exports
businessRouter.get(
  "/reports/export/sales-journal",
  ReportController.exportSalesJournal as any,
);
businessRouter.get(
  "/reports/export/staff-performance",
  ReportController.exportStaffPerformance as any,
);
businessRouter.get(
  "/reports/export/stock-status",
  ReportController.exportStockStatus as any,
);
businessRouter.get(
  "/reports/export/financial-balance",
  ReportController.exportFinancialBalance as any,
);

// POS sync status
businessRouter.get("/sync-status", BusinessController.getPosSyncStatus as any);

// Notifications
businessRouter.get("/notifications", NotificationController.getAll as any);
businessRouter.get(
...
businessRouter.delete(
  ...
  NotificationController.clearRead as any,
);
businessRouter.patch(
